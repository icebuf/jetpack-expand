 ...
 */
@ItemGroup("testcase")
@ResItem(name = R.string.test_name_nested_radio_group,
        description = R.string.test_desc_nested_radio_group,
        destination = R.id.action_homeFragment_to_nestedFragment)
public class NestedFragment extends DBFragment<RadioViewModel> {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_nested;
    }
}
